...
public class clientInterface1 extends javax.swing.JFrame {

    public clientInterface1() {
        initComponents();
        start_up();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(clientInterface1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new clientInterface1().setVisible(true);
            }
        });
    }
