...
public class LoginClientInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        username.setText("email@email.com");
        username.setToolTipText("email@email.com"); // NOI18N
            ...
            .addGroup(panelLoginInputLayout.createSequentialGroup()
                ...
                .addGroup(panelLoginInputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelLoginInputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(username, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 187, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        if (username.getText().equals("email@email.com") || username.getText().isEmpty() || password.getText().isEmpty()
                || !username.getText().contains("@") && !username.getText().contains(".")) {
    ...
    private void usernameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_usernameFocusGained
        ...
        clearTextBox(username, "email@email.com");
    }//GEN-LAST:event_usernameFocusGained

    private void passwordFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_passwordFocusGained
        username.setFocusable(true);
        clearTextBox(password, "jPasswordField1");
