...
class ClientDAOTest {
    ...
    public void testGetClientBalanceFound() {
        int testClientId = 3;
        Double balance = ClientDAO.getClientBalance(testClientId);
        assertNotNull(balance);
        assertTrue(balance >= 0); //assumindo que o saldo não pode ser negativo, se poder aí tem que se remover esta linha
    }
    ...
    public void testUpdateClientSuccess() {
        int result = ClientDAO.UpdateClient("João Tomás Silva", "Avenida Lourenço Peixinho, 123, Aveiro, Portugal", "joaotomassilva@gmail.com", "923344551", "119876543", "joao2024silva", "joaosilva@gmail.com");
        assertEquals(ClientDAO.codigoSucesso, result);
    }

    @Test
    public void testUpdateClientErrorEmail() {
        int result = ClientDAO.UpdateClient("João Tomás Silva", "Avenida Lourenço Peixinho, 123, Aveiro, Portugal", "richard@ua.pt", "923344551", "119876543", "joao2024silva", "joaotomassilva@gmail.com");
        assertEquals(ClientDAO.codigoErroEmail, result);
    }

    @Test
    public void testUpdateClientNoChange() {
        int result = ClientDAO.UpdateClient("João Tomás Silva", "Avenida Lourenço Peixinho, 123, Aveiro, Portugal", "joaotomassilva@gmail.com", "923344551", "119876543", "joao2024silva", "joaotomassilva@gmail.com");
        assertEquals(ClientDAO.codigoSucesso, result);
    }
}