...
class FuncionarioDAOTest {
    ...
    public void testCreateFuncionarioSuccess() {
        int result = FuncionarioDAO.CreateFuncionario("Erling Haaland", "Leeds, Inglaterra", "haalandmc@gmail.com", "983453618", "333444555", "manchestercity9", 1);
        assertEquals(FuncionarioDAO.codigoSucesso, result);
    }

    @Test
    public void testUpdateFuncionarioBasicInfoSuccess() {
        int result = FuncionarioDAO.UpdateFuncionario("Erling Haaland", "Manchester, Inglaterra", "haalandmc9@gmail.com", "983453618", "333444555", "haalandmc@gmail.com");
        assertEquals(FuncionarioDAO.codigoSucesso, result);
    }

    @Test
    public void testUpdateFuncionarioWithPasswordSuccess() {
        int result = FuncionarioDAO.UpdateFuncionario("Erling Haaland", "Manchester, Inglaterra", "haalandmc9@gmail.com", "983453618", "333444555", "noruega9mc", "haalandmc9@gmail.com");
        assertEquals(FuncionarioDAO.codigoSucesso, result);
    }
    ...
    public void testGetFuncionarioByIDSuccess() {
        ...
        Funcionario resultado = FuncionarioDAO.getFuncionarioByID(validFuncionarioId);
    ...
    public void testGetFuncionarioByIDNotFound() {
        ...
        Funcionario resultado = FuncionarioDAO.getFuncionarioByID(invalidFuncionarioId);
    ...
    public void testGetFuncionarioNomeByIDSuccess() {
        ...
        String resultado = FuncionarioDAO.getFuncionarioNomeByID(validFuncionarioId);
        assertNotNull(resultado);
    ...
    public void testGetFuncionarioNomeByIDNotFound() {
        int invalidFuncionarioId = 9999;
        String resultado = FuncionarioDAO.getFuncionarioNomeByID(invalidFuncionarioId);
        assertNull(resultado);
    }
    ...
    public void testGetFuncionarioListByAddressSuccess() {
        ...
        ArrayList<Funcionario> resultado = FuncionarioDAO.getFuncionarioListByAddress(validAddress);
        assertNotNull(resultado);
        assertFalse(resultado.isEmpty());
    }
    ...
    public void testGetFuncionarioListByAddressNotFound() {
        ...
        ArrayList<Funcionario> resultado = FuncionarioDAO.getFuncionarioListByAddress(invalidAddress);
        assertNull(resultado);
    }
    ...
    public void testGetFuncionarioIdByEmailSuccess() {
        ...
        Integer resultado = FuncionarioDAO.getFuncionarioIdByEmail(emailExistente);
        assertNotNull(resultado);
    ...
    public void testGetFuncionarioIdByEmailNotFound() {
        ...
        Integer resultado = FuncionarioDAO.getFuncionarioIdByEmail(emailInexistente);
        assertNull(resultado);
    }
    ...
    public void testGetFuncionarioByNIFSuccess() {
        ...
        Funcionario funcionario = FuncionarioDAO.getFuncionarioByNIF(nifExistente);
    ...
    public void testGetFuncionarioByNIFNotFound() {
        ...
        Funcionario funcionario = FuncionarioDAO.getFuncionarioByNIF(nifInexistente);
    ...
    public void testGetNumDepositosPorAprovarSuccess() {
        Integer numDepositosPorAprovar = FuncionarioDAO.getNumDepositosPorAprovar();
    ...
    public void testGetNomeFuncionarioComMaisDepositosAprovadosSuccess() {
        String nomeFuncionario = FuncionarioDAO.getFuncionarioComMaisDepositosAprovados();
    ...
    public void testGetFuncionarioNumDepositosAprovadosSuccess() {
        String numDepositos = FuncionarioDAO.getFuncionarioNumDepositosAprovados(2);
